...
extension LBFMRadioSquareResultsCell: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.radioSquareModel = radioSquareResultsModel?[indexPath.row]
        return cell
    }
    
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let uriString:String = (radioSquareResults?[indexPath.row].uri)!
        let title :String = (radioSquareResults?[indexPath.row].title)!
