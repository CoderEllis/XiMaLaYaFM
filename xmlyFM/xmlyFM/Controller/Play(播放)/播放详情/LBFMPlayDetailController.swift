...
class LBFMPlayDetailController: UIViewController {
    ...
    private lazy var headerView:LBFMPlayDetailHeaderView = {
        let view = LBFMPlayDetailHeaderView.init(frame: CGRect(x:0, y:0, width:ScreenWidth, height:240))
    ...
    private lazy var advancedManager: LTAdvancedManager = {
        ...
        let advancedManager = LTAdvancedManager(frame: CGRect(x: 0, y: 0, width: ScreenWidth, height: ScreenHeight + LBFMNavBarHeight), viewControllers: viewControllers, titles: titles, currentViewController: self, layout: layout, headerViewHandle: {[weak self] in
    ...
    func setupLoadData() {
        LBFMPlayDetailProvider.request(LBFMPlayDetailAPI.playDetailData(albumId: albumId)) { (result) in
...
extension LBFMPlayDetailController: LTAdvancedScrollViewDelegate {
    ...
    func glt_scrollViewOffsetY(_ offsetY: CGFloat) {
        if offsetY > 5 {
            ...
            rightBarButton1.setImage(UIImage(named: "icon_more_n_30x31_"), for: .normal)
            rightBarButton2.setImage(UIImage(named: "icon_share_n_30x30_"), for: .normal)
        } else {
            navBarBackgroundAlpha = 0
            rightBarButton1.setImage(UIImage(named: "icon_more_h_30x31_"), for: .normal)
            rightBarButton2.setImage(UIImage(named: "icon_share_h_30x30_"), for: .normal)
        }
    }
}
